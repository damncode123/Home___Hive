...
const CreateListing = () => {
  ...
  const handlePost = async (e) => {
    ...
    try {
      ...
      listingForm.append("Email", formLocation.Email);
      listingForm.append("PhoneNumber", formLocation.phonenumber);
            ...
            <div className="half">
              ...
              <div className="location">
                ...
                <input
                  ...
                  name="phonenumber"
                  value={formLocation.phonenumber}
                  onChange={handleChangeLocation}
                  required
                />
              </div>
                ...
                <div className="basic_count">
                  <RemoveCircleOutline
                    ...
                    sx={{
                      fontSize: "25px",
                      cursor: "pointer",
                      "&:hover": { color: "#fb6f92" }, // Solid color value instead of variables.pinkred
                    }}
                  />
                  <p>{guestCount}</p>
                  <AddCircleOutline
